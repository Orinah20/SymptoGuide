...
if (isset($_POST['patient_id'], $_POST['patient_name'], $_POST['date_of_birth'], $_POST['gender'], $_POST['contact_number'], $_POST['address'])) {
    ...
    $updateQuery = "UPDATE patients SET patient_name = ?, date_of_birth = ?, gender = ?, contact_number = ?, address = ? WHERE patient_id = ?";
